...
summary_by_total |> filter(diet == "marine diet") |> pull(cpi) |> mean()/summary_by_total |> filter(diet == "plant diet") |> pull(cpi) |> mean()
...
#difference between minimum and maximum scores for each scenarios
...
Breakdown of distrubance variation
```{r}
