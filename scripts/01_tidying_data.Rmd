...
effort_by_daygearcell <- 
  ...
  this_days_data <- fread(this_effort_filepath) |> lazy_dt()
...
fwrite(x = effort_by_gearcell2017, file = here("data/tidy_data/pressures/forage-fishing-effort/annual_effort_2017.csv"))
