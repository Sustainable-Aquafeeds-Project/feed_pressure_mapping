...
writeRaster(x = trawl_effort_r, filename =here("data/spatial/03-fisheries-effort/gfw_annual_effort_2017_trawlers.tif"), overwrite=TRUE)
...
writeRaster(x = dredge_effort_r, filename = here("data/spatial/03-fisheries-effort/gfw_annual_effort_2017_dredge.tif"), overwrite=TRUE)
