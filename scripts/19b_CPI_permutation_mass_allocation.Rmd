...
(both_diets_disagg_p <- 
  ...
  # annotate("text", x = 3, y = y_breaks, label = as.character(y_breaks), size=2.1, colour="grey10")+
  # annotate("text", x = 1.5, y = y_breaks, label = as.character(y_breaks), size=2.1, colour="grey10"))
  # annotate("text", x = 3, y = y_breaks, label = as.character(y_breaks), size=2.8, colour="grey70")+
  # annotate("text", x = 4, y = y_breaks, label = as.character(y_breaks), size=2.8, colour="grey70")+
  # annotate("text", x = 5, y = y_breaks, label = as.character(y_breaks), size=2.8, colour="grey70"))
#boxplot version
...
#   guides(fill = guide_legend(override.aes = list(shape = NA)))
ggsave(filename = here("figures/disaggregation_of_pressures_mass_allocation.jpg"), width = 8.9, height=8, units = "cm", device = "jpg", dpi = 600)
```
