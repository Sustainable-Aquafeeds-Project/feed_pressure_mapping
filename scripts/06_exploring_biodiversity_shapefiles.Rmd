...
iucn_rich_local_dir <- "/Users/rsc2/Dropbox/Data/IUCN Red List/IUCN"
...
fc_list = rgdal::ogrListLayers(birds_gdb_file)
print(fc_list)


botw <- rgdal::readOGR(dsn=birds_gdb_file, layer="All_Species")
  
  #st_read(file.path(iucn_dir, "spp_shapefiles/BOTW/BOTW.gdb"), layer = "All_Species", METHOD = "SKIP")




st_write(birds_gdb, file.path(iucn_dir, "iucn/spp_shapefiles/BOTW/BOTW.shp"))
