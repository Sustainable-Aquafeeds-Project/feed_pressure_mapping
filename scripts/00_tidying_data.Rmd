...
map(.x = these_crop_yield_files, .f = \(this_file){
  ...
  this_agg_rast <- terra::aggregate(this_rast, fact=6)
...
map(.x = these_crop_area_files, .f = \(this_file){
  ...
  this_agg_rast <- terra::aggregate(this_rast, fact=6)*0.01 #aggregate to half degree and convert to km2
...
ge_allocation <- read_csv("/mnt/rdsi/raw_data/allocation/embodied_fish_ge_allocation.csv")
write_csv(x = ge_allocation, file = here("data/raw_data/allocation/embodied_fish_ge_allocation.csv"))



#Economic allocation of embodied fish from Kok et al
kok_et_al <- read_csv("/mnt/rdsi/raw_data/allocation/embodied_fish_kok_et_al.csv")
write_csv(x = kok_et_al, file = here("data/raw_data/allocation/embodied_fish_kok_et_al.csv"))
