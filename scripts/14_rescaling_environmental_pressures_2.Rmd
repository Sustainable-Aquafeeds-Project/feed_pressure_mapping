...
moll_rast <- project(base_rast, "ESRI:53009")
...
test <- rast(marine_diet_disturbance[[1]])
test_rp <- project(test, moll_rast)
test_rs <- resample(test_rp, moll_rast)

test |> no_na_values() |> sum()
test_rs |> no_na_values() |> sum()
test_rp |> no_na_values() |> sum()
