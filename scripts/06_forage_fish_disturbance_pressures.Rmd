...
map(.x = forage_catch_r_list_md, .f = \(this_file){
  ...
  all_trawL_r <- rast(here("data/spatial/fisheries-effort/all_trawling_catch.tif")) |>  extend(rast(res=0.5))
...
### Holding off on rescaling until we know what we want to rescale all rasters to 
...
#STILL TO CONFIRM IF I NEED TO DO THIS AT THIS LEVEL OR AT THE LEVEL OF THE FEED.
