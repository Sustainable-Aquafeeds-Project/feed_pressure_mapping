...
forage_spp <- readRDS(here("data/large_data/spatial_forage_catch_2017.rds")) |> mutate(binomial = stringi::stri_count(TaxonName, regex="\\S+")) |> filter(binomial==2) |>  pull(TaxonName) |> unique() 
...
Catch for trimmings - first lets get the latin names of the trimmings spp catch from the filtered catch data and find the trophic levels of them.
