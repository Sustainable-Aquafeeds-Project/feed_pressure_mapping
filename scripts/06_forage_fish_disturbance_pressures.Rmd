...
map(trawl_forage_catch_list, \(this_df){
  ...
  this_summary_df <- 
    this_df |> 
    group_by(LonCentre, LatCentre) |> 
    summarise(forage_catch = sum(embodied_fish_adj_fm, na.rm=TRUE))
  
  
  this_rast <- rast(this_summary_df, type="xyz", crs="EPSG:4326")
  this_rast_resampled <- resample(this_rast, rast(res=0.5))
  
  writeRaster(x = this_rast_resampled, filename = sprintf(here("data/spatial/%s/int/fishmeal_trawl_catch_%s_%s.tif"), this_diet, this_diet, this_source), overwrite=TRUE)
...
fm_catch_r_list_md <- fm_catch_r_list_int_md[!grepl("_prop", fm_catch_r_list_int_md)]

#test
this_file <- fm_catch_r_list_md[[3]]
...
fm_catch_r_list_pd <- fm_catch_r_list_int_pd[!grepl("_prop", fm_catch_r_list_int_pd)]
...
fm_effort_files_md <- fm_effort_files_int_md[!grepl("0.5D_km2", fm_effort_files_int_md)]

this_file <- forage_effort_files_md[[1]]

#aggregate the effort data to 0;5 degrees and adjust to effort for km2

map(.x = fm_effort_files_int_md, .f = \(this_file){
...
fm_effort_files_pd <- fm_effort_files_int_pd[!grepl("0.5D_km2", fm_effort_files_int_pd)]
...
md_fm_effort_km2_r_files <- md_fm_effort_km2_r_files[grepl("fishmeal", md_fm_effort_km2_r_files)]

#get all the values for the forage trawl effort rasters

md_fm_effort_km2_r_list <- map(md_fm_effort_km2_r_files, \(this_file){
...
#check for outliers
hist(unlist(md_fm_effort_km2_r_list))
abline(v=quantile(unlist(md_fm_effort_km2_r_list), 0.999), lty=2)
...
md_fm_rescaled_benthic_list <- 
  ...
  map(.x = md_fm_effort_km2_r_files, .f = \(this_file){
    ...
    if(!file.exists(saveName)){
      ...
      all_effort_values <- unlist(md_fm_effort_km2_r_list)
...
pd_fm_effort_km2_r_files <- pd_fm_effort_km2_r_files[grepl("fishmeal", pd_fm_effort_km2_r_files)]


#get all the values for the forage trawl effort rasters

pd_fm_effort_km2_r_list <- map(pd_fm_effort_km2_r_files, \(this_file){
...
pd_fm_rescaled_benthic_list <- 
  ...
  map(.x = pd_fm_effort_km2_r_files, .f = \(this_file){
    ...
    if(!file.exists(saveName)){
      ...
      all_effort_values <- unlist(pd_fm_effort_km2_r_list)
...
fm_catch_list <- fread(here("data/tidy_data/demand/embodied_fish_per_cell.csv")) |> 
  ...
  summarise(catch = sum(embodied_fish_adj_fm, na.rm=TRUE)) |> 
  as_tibble() |> 
  group_split(diet, source_code)
...
map(fm_catch_list, \(this_df){
  ...
  saveName <- sprintf(here("data/spatial/%s/production/fishmeal_catch_%s_%s.tif"), this_diet, this_diet, this_source)
...
fm_catch_r_list_md <- fm_catch_r_list_int_md[!grepl("ea_npp", fm_catch_r_list_int_md)]
...
fm_catch_r_list_pd <- fm_catch_r_list_int_pd[!grepl("ea_npp", fm_catch_r_list_int_pd)]
...
adjusted_fm_catch_r_list_md <- list.files(here("data/spatial/marine_diet/int"), pattern = "ea_npp", full.names = TRUE) 
adjusted_fm_catch_r_list_md <- adjusted_fm_catch_r_list_md[grepl("fishmeal", adjusted_fm_catch_r_list_md)]

adjusted_fm_catch_r_list_pd <- list.files(here("data/spatial/plant_diet/int"), pattern = "ea_npp", full.names = TRUE) 
adjusted_fm_catch_r_list_pd <- adjusted_fm_catch_r_list_pd[grepl("fishmeal", adjusted_fm_catch_r_list_pd)] 


adjusted_fm_catch_r_list_all <- c(adjusted_fm_catch_r_list_md, adjusted_fm_catch_r_list_pd) |> map(rast)
...
fm_rescaled_biomass_list <- 
  ...
  saveName <- sprintf(here("data/spatial/%s/int/fishmeal_biomass_removal_rescaled_%s_%s.tif"), this_diet, this_diet, this_source)
  
  if(!file.exists(saveName)){
    
    all_catch_values <- unlist(map(adjusted_fm_catch_r_list_all, \(this_r){return(c(terra::values(this_r, na.rm=TRUE)))}))
...
combined_raster_list <- 
  ...
  writeRaster(x = this_km2_combined_r, filename = sprintf(here("data/spatial/marine_diet/int/fishmeal_disturbance_km2_%s.tif"), this_source), overwrite=TRUE)
...
combined_raster_list2 <- 
 ...
 writeRaster(x = this_km2_combined_r, filename = sprintf(here("data/spatial/plant_diet/int/fishmeal_disturbance_km2_%s.tif"), this_source), overwrite=TRUE)
...
map(trawl_forage_catch_list, \(this_df){
  ...
  this_summary_df <- 
    this_df |> 
    group_by(LonCentre, LatCentre) |> 
    summarise(forage_catch = sum(embodied_fish_adj_fo, na.rm=TRUE))
  
  
  this_rast <- rast(this_summary_df, type="xyz", crs="EPSG:4326")
  this_rast_resampled <- resample(this_rast, rast(res=0.5))
  
  writeRaster(x = this_rast_resampled, filename = sprintf(here("data/spatial/%s/int/fish oil_trawl_catch_%s_%s.tif"), this_diet, this_diet, this_source), overwrite=TRUE)
...
fo_catch_r_list_md <- fo_catch_r_list_int_md[!grepl("_prop", fo_catch_r_list_int_md)]
...
fo_catch_r_list_pd <- fo_catch_r_list_int_pd[!grepl("_prop", fo_catch_r_list_int_pd)]
...
#proportional catch raster for forage fish trawling
prop_raster_files_md <- list.files(path = here("data/spatial/marine_diet/int"), pattern = "_prop.tif", full.names = TRUE)
prop_raster_files_md <- prop_raster_files_md[grepl(pattern = "fish oil", x = prop_raster_files_md)]
...
#proportional catch raster for forage fish trawling
prop_raster_files_pd <- list.files(path = here("data/spatial/plant_diet/int"), pattern = "_prop.tif", full.names = TRUE)
prop_raster_files_pd <- prop_raster_files_pd[grepl(pattern = "fish oil", x = prop_raster_files_pd)]
...
fo_effort_files_md <- fo_effort_files_int_md[!grepl("0.5D_km2", fo_effort_files_int_md)]
...
fo_effort_files_pd <- fo_effort_files_int_pd[!grepl("0.5D_km2", fo_effort_files_int_pd)]
...
md_fo_effort_km2_r_files <- md_fo_effort_km2_r_files[grepl("fish oil", md_fo_effort_km2_r_files)]

#get all the values for the forage trawl effort rasters

md_fo_effort_km2_r_list <- map(md_fo_effort_km2_r_files, \(this_file){
...
#check for outliers
hist(unlist(md_fo_effort_km2_r_list))
abline(v=quantile(unlist(md_fo_effort_km2_r_list), 0.999), lty=2)
...
md_fo_rescaled_benthic_list <- 
  ...
  map(.x = md_fo_effort_km2_r_files, .f = \(this_file){
    ...
    if(!file.exists(saveName)){
      ...
      all_effort_values <- unlist(md_fo_effort_km2_r_list)
...
pd_fo_effort_km2_r_files <- pd_fo_effort_km2_r_files[grepl("fish oil", pd_fo_effort_km2_r_files)]


#get all the values for the forage trawl effort rasters

pd_fo_effort_km2_r_list <- map(pd_fo_effort_km2_r_files, \(this_file){
...
pd_fo_rescaled_benthic_list <- 
  ...
  map(.x = pd_fo_effort_km2_r_files, .f = \(this_file){
    ...
    if(!file.exists(saveName)){
      ...
      all_effort_values <- unlist(pd_fo_effort_km2_r_list)
...
#split the embodied fish from fishmeal xy file by diet and source
fo_catch_list <- fread(here("data/tidy_data/demand/embodied_fish_per_cell.csv")) |> 
  lazy_dt(immutable = FALSE) |> 
  group_by(diet, source_code, LonCentre, LatCentre) |> 
  summarise(catch = sum(embodied_fish_adj_fo, na.rm=TRUE)) |> 
  as_tibble() |> 
  group_split(diet, source_code)
...
map(fo_catch_list, \(this_df){
  ...
  saveName <- sprintf(here("data/spatial/%s/production/fish oil_catch_%s_%s.tif"), this_diet, this_diet, this_source)
...
fo_catch_r_list_md <- fo_catch_r_list_int_md[!grepl("ea_npp", fo_catch_r_list_int_md)]
...
fo_catch_r_list_pd <- fo_catch_r_list_int_pd[!grepl("ea_npp", fo_catch_r_list_int_pd)]
...
adjusted_fo_catch_r_list_md <- adjusted_fo_catch_r_list_md[grepl("fish oil", adjusted_fo_catch_r_list_md)]

adjusted_fo_catch_r_list_pd <- list.files(here("data/spatial/plant_diet/int"), pattern = "ea_npp", full.names = TRUE) 
adjusted_fo_catch_r_list_pd <- adjusted_fo_catch_r_list_pd[grepl("fish oil", adjusted_fo_catch_r_list_pd)] 
...
fo_rescaled_biomass_list <- 
  ...
  saveName <- sprintf(here("data/spatial/%s/int/fish oil_biomass_removal_rescaled_%s_%s.tif"), this_diet, this_diet, this_source)
  
  if(!file.exists(saveName)){
    
    all_catch_values <- unlist(map(adjusted_fo_catch_r_list_all, \(this_r){return(c(terra::values(this_r, na.rm=TRUE)))}))
...
combined_raster_list <- 
  ...
  writeRaster(x = this_km2_combined_r, filename = sprintf(here("data/spatial/marine_diet/int/fish oil_disturbance_km2_%s.tif"), this_source), overwrite=TRUE)
...
combined_raster_list2 <- 
 ...
 writeRaster(x = this_km2_combined_r, filename = sprintf(here("data/spatial/plant_diet/int/fish oil_disturbance_km2_%s.tif"), this_source), overwrite=TRUE)
