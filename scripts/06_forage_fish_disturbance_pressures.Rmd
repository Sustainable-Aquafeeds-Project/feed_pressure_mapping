...
Using the marine footprint approach outlined in Cashion
...
(forage_npp <- 
    ...
    ungroup() |> 
    mutate(ppr_prop_fm_mass = case_when(ppr_fm_mass/mean_npp_t_C_yr<1 ~ ppr_fm_mass/mean_npp_t_C_yr,
                                        TRUE ~ ppr_fm_mass/max_npp_t_C_yr),
           
           ppr_prop_fo_mass = case_when(ppr_fo_mass/mean_npp_t_C_yr<1 ~ ppr_fo_mass/mean_npp_t_C_yr,
                                        TRUE ~ ppr_fo_mass/max_npp_t_C_yr),
           ppr_prop_fm_ge = case_when(ppr_fm_ge/mean_npp_t_C_yr<1 ~ ppr_fm_ge/mean_npp_t_C_yr,
                                      TRUE ~ ppr_fm_ge/max_npp_t_C_yr),
           ppr_prop_fo_ge = case_when(ppr_fo_ge/mean_npp_t_C_yr<1 ~ ppr_fo_ge/mean_npp_t_C_yr,
...
forage_fmfo_yield |> filter(fao_area_code==61)
