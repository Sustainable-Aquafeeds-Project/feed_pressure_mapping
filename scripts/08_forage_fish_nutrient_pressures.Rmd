...
map(.x = fm_template_files, .f = \(this_file){
  ...
  saveName_N_md <- sprintf(here("data/spatial/marine_diet/int/fishmeal_N_km2_%s.tif"), this_source)
  saveName_N_pd <- sprintf(here("data/spatial/plant_diet/int/fishmeal_N_km2_%s.tif"), this_source)
...
map(.x = fo_template_files, .f = \(this_file){
  ...
  saveName_N_md <- sprintf(here("data/spatial/marine_diet/int/fish oil_N_km2_%s.tif"), this_source)
  saveName_N_pd <- sprintf(here("data/spatial/plant_diet/int/fish oil_N_km2_%s.tif"), this_source)
...
map(.x = fm_template_files, .f = \(this_file){
  ...
  saveName_P_md <- sprintf(here("data/spatial/marine_diet/int/fishmeal_P_km2_%s.tif"), this_source)
  saveName_P_pd <- sprintf(here("data/spatial/plant_diet/int/fishmeal_P_km2_%s.tif"), this_source)
...
map(.x = fo_template_files, .f = \(this_file){
  ...
  saveName_P_md <- sprintf(here("data/spatial/marine_diet/int/fish oil_P_km2_%s.tif"), this_source)
  saveName_P_pd <- sprintf(here("data/spatial/plant_diet/int/fish oil_P_km2_%s.tif"), this_source)
