...
fm_template_files <- list.files(path = here("data/spatial/marine_diet/int"), pattern = "fishmeal_ghg_raw", full.names = TRUE)
...
map2(.x = fm_N_files, .y = fm_P_files, .f=\(this_N_file, this_P_file){
  ...
  this_allocation_method <- c(str_extract(this_N_file, "ge_allocation|mass_allocation"), str_extract(this_P_file, "ge_allocation|mass_allocation")) |> unique()
