...
# now adjust the MAPSPAM rasters by the factors identified


mapspam_adj_list <- mapspam_fao_compare |> 
  group_by(item, iso3c, area) |> 
  group_split()
...
crop_area_files <- list.files(here("data/spatial/crop-layers-adjusted"), pattern = "_A_", full.names = TRUE)
