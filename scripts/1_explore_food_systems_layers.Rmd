...
ggplot()+
  geom_sf(data = countries_shp %>% filter(iso_a3!="ATA"), fill="grey90", colour="grey90")+
  ...
  guides(fill = guide_colorbar(barheight = unit(0.3, "cm"), title.position = "top", title.hjust = 0.5))
