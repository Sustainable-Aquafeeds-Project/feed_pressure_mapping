...
```{r}
md_ingredient_source_list <- crossing(ingredient = marine_diet, source = 1:3) |> group_split(ingredient)
...
```{r}
pd_ingredient_source_list <- crossing(ingredient = plant_diet, source = 1:3) |> group_split(ingredient)
