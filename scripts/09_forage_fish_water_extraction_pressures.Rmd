...
map(.x = template_files, .f = \(this_file){
  ...
  saveName_md <- sprintf(here("data/spatial/marine_diet/int/forage_fish_water_km2_%s.tif"), this_source)
  saveName_pd <- sprintf(here("data/spatial/plant_diet/int/forage_fish_water_km2_%s.tif"), this_source)
