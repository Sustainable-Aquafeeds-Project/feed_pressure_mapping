...
forage_supply_demand_list <- 
  forage_supply_demand_by_diet |> 
  mutate(fm_prop_embodied_fish = fm_embodied_fish/total_embodied_fish) |> 
  mutate(fo_prop_embodied_fish = fo_embodied_fish/total_embodied_fish) |> 
  relocate(diet, .before = source_code) |> 
...
forage_supply_demand_redistributed_fmfo <- 
  forage_supply_demand_redistributed |> 
  mutate(embodied_fish_adj_fm = fm_prop_embodied_fish*adj_embodied_fish,
         embodied_fish_adj_fo = fo_prop_embodied_fish*adj_embodied_fish)
