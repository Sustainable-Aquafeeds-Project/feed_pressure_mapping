...
For the final step, we need to normalise the effort 

```{r}

forage_effort_km2_r_files <- list.files(path = here("data/spatial/03-fisheries-effort"), pattern = "_0.5D_km2", full.names = TRUE) 

forage_effort_km2_r_list <- rast(forage_effort_km2_r_files)

this_file <- forage_effort_km2_files[[1]]

map(.x = forage_effort_km2_files, .f = \(this_file){
