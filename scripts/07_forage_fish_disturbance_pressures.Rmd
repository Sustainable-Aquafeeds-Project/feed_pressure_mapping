...
map(catch_list, \(this_df){
  ...
  saveName <- sprintf(here("data/spatial/%s/forage_fish_catch_%s_%s.tif"), this_diet, this_diet, this_source)
...
catch_r_list_int_md <- list.files(here("data/spatial/marine_diet"), pattern = "forage_fish_catch", full.names = TRUE)
...
map(catch_r_list_md, \(this_file){
  ...
  saveName <- gsub(pattern = ".tif", replacement = "_ea_npp.tif", this_file)
...
catch_r_list_int_pd <- list.files(here("data/spatial/plant_diet"), pattern = "forage_fish_catch", full.names = TRUE)
