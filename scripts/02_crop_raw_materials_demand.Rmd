...
crop_raw_material_demand <- readRDS(here("data/tidy_data/demand/total_ingredient_demand_by_diet.rds")) |> 
  ungroup() |> 
  ...
  rename(FAOSTAT_name = item,
         source_country = area,
         source_iso3c = iso3c) |> 
  mutate(total_crop_demand_ge = ingredient_demand_tonnes*ge_allocation_factor,
         total_crop_demand_ms = ingredient_demand_tonnes*mass_allocation_factor)
