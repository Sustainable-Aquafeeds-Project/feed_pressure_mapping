...
(p <- ggplot()+
  ...
  theme_bw()+
    ...
    labs(fill = "Soy production\n(km2)", title = "Myrmecophaga tridactyla (Giant anteater)\nDasypus hybridus (Southern long-nosed armadillo)"))

ggsave(filename = here("explore/explore_brazil_species_impacts.jpg"), device = "jpg", dpi=300, height = 20, width = 12, units =  "cm")
