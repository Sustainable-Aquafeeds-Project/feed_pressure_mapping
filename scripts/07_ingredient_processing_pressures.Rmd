  ...
  map(these_ingredients, .f = \(this_ingredient){
    ...
    map(these_ingredient_files, \(this_ingredient_source){
      ...
      if(!this_ingredient %in% c("fishmeal", "fish oil")){
        ...
        writeRaster(this_N_value_km2_rast, filename = sprintf(here("data/spatial/%s/int/%s_processing_N_km2_%s_%s.tif"), this_diet, this_ingredient, this_allocation_method, this_source), overwrite = TRUE)
        ...
        writeRaster(this_P_value_km2_rast, filename = sprintf(here("data/spatial/%s/int/%s_processing_P_km2_%s_%s.tif"), this_diet, this_ingredient, this_allocation_method, this_source), overwrite = TRUE)
