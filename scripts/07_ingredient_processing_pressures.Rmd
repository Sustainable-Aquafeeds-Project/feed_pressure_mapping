  ...
  map(these_ingredients, .f = \(this_ingredient){
    ...
    map(these_ingredient_files, \(this_ingredient_source){
      ...
      if(!this_ingredient %in% c("fishmeal", "fish oil")){
        ...
        this_ghg_value_km2_rast <- this_ghg_value_rast/cellSize(this_ghg_value_rast)
        ...
        this_dist_value_km2_rast <- this_dist_value_rast/cellSize(this_dist_value_rast)
        ...
        this_N_value_km2_rast <- this_N_value_rast/cellSize(this_N_value_rast)         
        ...
        this_P_value_km2_rast <- this_P_value_rast/cellSize(this_P_value_rast)
        ...
        this_h2o_value_km2_rast <- this_h2o_value_rast/cellSize(this_h2o_value_rast)
