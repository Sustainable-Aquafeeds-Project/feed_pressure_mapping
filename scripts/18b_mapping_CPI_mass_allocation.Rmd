...
(marine_sourcing_p1 <- 
  ...
  scale_fill_gradientn(
    ...
    annotate("text", x = 17985650*0.8, y = -7298155*1.2, label = as.expression(bquote(Sigma~CPI==.(source_marine_1))), size = 3)
  )
...
(marine_sourcing_p2 <- 
  ...
  scale_fill_gradientn(colours = final_palette, 
    ...
    annotate("text", x = 17985650*0.8, y = -7298155*1.2, label = as.expression(bquote(Sigma~CPI==.(source_marine_2))), size = 3)
  )
...
(plant_sourcing_p1 <- 
  ...
  scale_fill_gradientn(colours = final_palette, 
    ...
    guides(fill = guide_colorbar(direction = "horizontal", title.position = "top", title = "Cumulative pressure index", title.hjust = 0.5,
                                 barwidth = 10, barheight = 0.5, units = "cm"))+
    annotate("text", x = 17985650*0.8, y = -7298155*1.2, label = as.expression(bquote(Sigma~CPI==.(source_plant_1))), size = 3)
  )
...
(plant_sourcing_p2 <- 
  ...
  scale_fill_gradientn(colours = final_palette, 
    ...
    guides(fill = guide_colorbar(direction = "horizontal", title.position = "top", title = "Cumulative pressure index", title.hjust = 0.5,
                                barwidth = 10, barheight = 0.5, units = "cm"))+
    annotate("text", x = 17985650*0.8, y = -7298155*1.2, label = as.expression(bquote(Sigma~CPI==.(source_plant_2))), size = 3)
  )
...
(plant_sourcing_p3 <- 
  ...
  scale_fill_gradientn(colours = final_palette, 
    ...
    guides(fill = guide_colorbar(direction = "horizontal", title.position = "top", title = "Cumulative pressure index", title.hjust = 0.5,
                                 barwidth = 10, barheight = 0.5, units = "cm"))+
    annotate("text", x = 17985650*0.8, y = -7298155*1.2, label = as.expression(bquote(Sigma~CPI==.(source_plant_3))), size =3)
  )
...
(marine_sourcing_p3 <- 
  ...
  scale_fill_gradientn(colours = final_palette, 
    ...
    guides(fill = guide_colorbar(direction = "horizontal", title.position = "top", title = "Cumulative pressure index", title.hjust = 0.5,
                                 barwidth = 7, barheight = 0.4, units = "cm"))
    #annotate("text", x = -22000000, y = sum(c(-9008064, 9009955))|> mean(), label = "Raw material origin\ncombination 3", angle = 90)+
    #annotate("text", x = 17985650*0.8, y = -7298155*1.2, label = as.expression(bquote(Sigma~CPI==.(source_marine_3))), size = 3)
  )

ggsave(here("figures/single_CPI_map.jpeg"), device = "jpg", dpi = 600, width = 8.9, height = 6, units = "cm")
