...
marine_source_ingredient <- 
  marine_diets |> 
  select(ingredient) |> 
  mutate(source_1 = c(1, 1, 2, 2, 2, 5, 1),
         source_2 = c(2, 3, 1, 1, 4, 2, 3),
         source_3 = c(3, 5, 3, 3, 3, 2, 4)) |> 
...
for(source in sources){
    ...
    marine_diet_files <- 
      map(.x = marine_source_ingredient, .f = \(this_df){
        ...
        #nutrients
        this_nutrient_file <- these_ingredient_files[grepl("nutrient", these_ingredient_files)][[this_source_ingredient]]
...
options(warn = oldw)
marine_diet_raster |> map(no_na_values) |> map(sum)
plant_diet_raster |> map(no_na_values) |> map(sum)
```
...
source_marine_1 <- round(sum_marine_value[["source_1"]], digits = 2) 
source_marine_2 <- round(sum_marine_value[["source_2"]], digits = 2)
source_marine_3 <- round(sum_marine_value[["source_3"]], digits = 2)
source_plant_1 <- round(sum_plant_value[["source_1"]], digits = 3)
source_plant_2 <- round(sum_plant_value[["source_2"]], digits = 2)
source_plant_3 <- round(sum_plant_value[["source_3"]], digits = 2)
...
(marine_sourcing_p1 <- 
  ...
  scale_fill_gradientn(
    ...
    annotate("text", x = 17985650*0.8, y = -7298155*1.2, label = as.expression(bquote(Sigma~CPI==.(format(round(source_marine_1, digits = 2), nsmall=2)))), size = 3)
  )
...
(marine_sourcing_p2 <- 
  ...
  scale_fill_gradientn(colours = final_palette, 
    ...
    annotate("text", x = 17985650*0.8, y = -7298155*1.2, label = as.expression(bquote(Sigma~CPI==.(format(round(source_marine_2, digits=2), nsmall=2)))), size = 3)
  )
...
(marine_sourcing_p3 <- 
  ...
  scale_fill_gradientn(colours = final_palette, 
    ...
    annotate("text", x = 17985650*0.8, y = -7298155*1.2, label = as.expression(bquote(Sigma~CPI==.(format(round(source_marine_3, digits =2), nsmall=2)))), size = 3)
  )
...
(plant_sourcing_p1 <- 
  ...
  scale_fill_gradientn(colours = final_palette, 
    ...
    guides(fill = guide_colorbar(direction = "horizontal", title.position = "top", title = "Cumulative pressure index", title.hjust = 0.5,
                                 barwidth = 10, barheight = 0.5, units = "cm"))+
    annotate("text", x = 17985650*0.8, y = -7298155*1.2, label = as.expression(bquote(Sigma~CPI==.(format(round(source_plant_1, digits = 2), nsmall = 2)))), size = 3)
  )
...
(plant_sourcing_p2 <- 
  ...
  scale_fill_gradientn(colours = final_palette, 
    ...
    guides(fill = guide_colorbar(direction = "horizontal", title.position = "top", title = "Cumulative pressure index", title.hjust = 0.5,
                                barwidth = 10, barheight = 0.5, units = "cm"))+
    annotate("text", x = 17985650*0.8, y = -7298155*1.2, label = as.expression(bquote(Sigma~CPI==.(format(round(source_plant_2, digits =2), nsmall=2)))), size = 3)
  )
...
(plant_sourcing_p3 <- 
  ...
  scale_fill_gradientn(colours = final_palette, 
    ...
    guides(fill = guide_colorbar(direction = "horizontal", title.position = "top", title = "Cumulative pressure index", title.hjust = 0.5,
                                 barwidth = 10, barheight = 0.5, units = "cm"))+
    annotate("text", x = 17985650*0.8, y = -7298155*1.2, label = as.expression(bquote(Sigma~CPI==.(format(round(source_plant_3, digits=2), nsmall=2)))), size =3)
  )
