...
efcr <- feed_demand |> pull(weighted_mean) |> unique() |> round(digits = 1)
...
#calculate ingredient demand for 1000 tonnes using the weighted efcr

map_df(diet_files, readRDS) |> 
  mutate(production_tonnes = 1000, 
         efcr = efcr) |> 
