...
fm_dist_plot <- 
  ...
  annotation_custom2(ff_png, xmin = 0.5, xmax = 2, ymin = 590, ymax = 630, data = fo_disturbance_df |> filter(diet == "Fish-dominant"))
...
soy_dist_plot <- 
  ...
  labs(fill = "Country", y = bquote(Disturbance~(km^2~eq.)), x = "", pattern = "Stage")+
   annotate("segment", x = 3, xend = 3, y=-30, yend = -43)+
  geom_text(data = facet_text, aes(x = area_name+0.75, y = sum), label = "SBM/SPC (17/20%)", size=2.5, fontface="bold")+
  annotation_custom2(soy_png, xmin = 0.5, xmax = 1.5, ymin = 500, ymax = 630, data = soy_disturbance_df |> filter(diet == "Fish-dominant"))
...
fm_ghg_plot <- 
  ...
  geom_text(data = facet_text, aes(x = area_name+0.75, y = sum), label = "Fishmeal (32/15%)", size=2.5, fontface="bold")+
  annotation_custom2(ff_png, xmin = .5, xmax = 2, ymin = 332000, ymax = 362000, data = fo_disturbance_df |> filter(diet == "Fish-dominant"))
...
soy_ghg_plot <- 
  ...
  geom_text(data = facet_text, aes(x = area_name+0.75, y = sum), label = "SBM/SPC (17/20%)", size=2.5, fontface="bold")+
  annotation_custom2(soy_png, xmin = 0.5, xmax = 1.5, ymin = 302000, ymax = 352000, data = soy_disturbance_df |> filter(diet == "Fish-dominant"))
...
faba_water_plot <- 
  ...
  geom_text(data = facet_text, aes(x = area_name+0.75, y = sum), label = "Faba beans (2/3%)", size=2.5, fontface="bold")+
