...
(marine_diet <- 
  ...
  scale_fill_manual(values = rcartocolor::carto_pal(n=5, name = "Safe"))+
   scale_y_continuous(expand = c(0,0), limits = c(0,0.302), breaks = c(0.1, 0.2, 0.3))+
  theme_bw()+
  theme(
...
ggsave(here("figures/disaggregation_of_pressure_by_ingredient.jpg"), dpi = 600, width = 16, height =13, units="cm")
