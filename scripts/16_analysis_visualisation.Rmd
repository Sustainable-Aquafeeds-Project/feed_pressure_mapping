...
ggsave(filename = here("figures/diet_permutation_comparisons.jpg"), device = "jpg", dpi = 600, width = 18, height = 9, units="cm")
...
plant_vals[plant_vals<max_marine] |> length()/ length(plant_vals) #88.8%
...
ggplot(data= summarised_pressure_disagg_df, aes(x = pressure, y = mean, fill = diet)
  ...
  labs(y = "Cumulative pressure index")+
