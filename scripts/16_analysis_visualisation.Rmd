...
ggplot(data= summarised_pressure_disagg_df, aes(x = pressure, y = median, fill = diet)
       )+
  geom_col( position = "dodge", width = 0.75, alpha = 0.8)+
  geom_point(position = position_dodge(width = 0.7), size=0.6)+
  geom_errorbar(aes(x = pressure, ymin = lq, ymax = uq), position = position_dodge(width=0.7), width = 0, size = 0.5)+
...
Diaggreagte by ingredients and pressures -  Marine diets
