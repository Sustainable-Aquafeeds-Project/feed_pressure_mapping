...
Once we have compared the two diets with different sourcing combinations, it's important to know how they disaggregate into what the pressures are that are causing them
...
#get the rasters from the file combinations
...
marine_source_rast_list[[2]]
```




# Sourcing and ingredient or raw material disaggregation
