...
min(plant_vals)/max(marine_vals) #plant diets can have CPI 61% lower than marine diets
...
(marine_diet <- 
  ...
  geom_errorbar(aes(x = ingredient, ymin = mean-sd, ymax = mean+sd), position = position_dodge(width=0.9), width = 0, size = 0.2)
