...
We're now interested from where the different crop ingredients could be sourced across the top producing nations. Need to check whether the demand from the global salmon industry can be met by crop producing countries
...
this_ingredient_source <- ingredient_per_country_per_diet[[14]]
...
#external pointer warning occurs but ignore - this runs fine. Its a terra  parallel core issue
