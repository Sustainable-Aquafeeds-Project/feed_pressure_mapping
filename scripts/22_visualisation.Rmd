...
ggplot(data = fo_disturbance_df)+
  ...
  labs(fill = "FAO fishing area", y = bquote(Disturbance~(km^2~eq.)), x = "Feed scenario", pattern = "Stage")+
...
ggplot(data = soy_disturbance_df)+
  ...
  labs(fill = "Country", y = bquote(Disturbance~(km^2~eq.)), x = "Feed scenario", pattern = "Stage")+
...
#Wheat gluten nutrients plot
  ...
  #theme(plot.margin = unit(c(1,1,1,0), "lines"))+
    ...
    annotate("text", x = 0.75, y = 125, size=0.8, label = "Wheat gluten")
