...
forage_catch <- readRDS(here("data/large_data/spatial_forage_catch_2017.rds")) |> 
  #should filter out gears that are not used for industrial catch
...
saveRDS(object = embodied_fish_demand_by_diet_source, file = here("data/tidy_data/demand/embodied_foragefish_demand_by_source_diet.rds"))
  ...
  map_df(.x =  c("marine_diet", "plant_diet"), .f = \(this_diet){
    ...
    this_df <- trim_fmfo_yield |> 
      mutate(diet = this_diet,
             ...
             #calculate embodied demand
             #calculated the embodied fish from fm and fo
             fm_embodied_fish_mass = distributed_fm_demand_mass * mass_byproduct_cf_fishmeal,
             fo_embodied_fish_mass = distributed_fo_demand_mass * mass_byproduct_cf_fish_oil,
             fm_embodied_fish_ge = distributed_fm_demand_ge * ge_byproduct_cf_fishmeal,
             fo_embodied_fish_ge = distributed_fo_demand_ge * ge_byproduct_cf_fish_oil,
             #calculate the total fmfo demand
             total_fmfo_demand_mass = distributed_fm_demand_mass + distributed_fo_demand_mass,
             total_fmfo_demand_ge = distributed_fm_demand_ge + distributed_fo_demand_ge,
             #calculate the total embodied fish
