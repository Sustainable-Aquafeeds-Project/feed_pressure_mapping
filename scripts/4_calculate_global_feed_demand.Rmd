...
crop_production <- readRDS(file = here("data/tidy_data/crops_production_tidy.rds"))

crop_production |> 
  filter(element == "Production" & item %in% ingredient_by_raw_material$FAOSTAT_name & year %in% seq(from = 2015, to = 2020)) 
