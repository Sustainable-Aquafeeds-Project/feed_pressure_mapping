...
Next step is convert ingredient demand into raw material demand which will vary by processing technique (e.g. SPC vs SBM). This data is synthesised from multiple sources.
