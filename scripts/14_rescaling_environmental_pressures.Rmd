...
md_reprojected_rasters <- 
  ...
  map(.x = marine_diet_disturbance, .f = \(this_file){
    ...
    if(!file.exists(saveName)){
      ...
      # normalise by cell sizeto get proportion of cell before reprojecting otherwise reprojection screws up to be larger than cell size. 
...
```{r}
marine_diet_nutrients <- list.files(here("data/spatial/marine_diet/int"), pattern = "nutrient", full.names = TRUE)

plant_diet_nutrients <- list.files(here("data/spatial/plant_diet/int"), pattern = "nutrient", full.names = TRUE)
