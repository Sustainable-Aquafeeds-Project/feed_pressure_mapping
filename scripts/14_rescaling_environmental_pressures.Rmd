...
marine_diet_disturbance <- marine_diet_disturbance[!grepl("forage_fish", marine_diet_disturbance)]

plant_diet_disturbance <- list.files(here("data/spatial/plant_diet/int"), pattern = "disturbance_km2", full.names = TRUE)
plant_diet_disturbance <- plant_diet_disturbance[!grepl("forage_fish", plant_diet_disturbance)]
...
marine_diet_ghg <- marine_diet_ghg[!grepl("forage_fish", marine_diet_ghg)]

plant_diet_ghg <- list.files(here("data/spatial/plant_diet/int"), pattern = "ghg", full.names = TRUE)
plant_diet_ghg <- plant_diet_ghg[!grepl("forage_fish", plant_diet_ghg)]
...
marine_diet_N <- marine_diet_N[!grepl("forage_fish", marine_diet_N)]

plant_diet_N <- list.files(here("data/spatial/plant_diet/int"), pattern = "_N_", full.names = TRUE)
plant_diet_N <- plant_diet_N[!grepl("forage_fish", plant_diet_N)]
...
marine_diet_P <- marine_diet_P[!grepl("forage_fish", marine_diet_P)]

plant_diet_P <- list.files(here("data/spatial/plant_diet/int"), pattern = "_P_", full.names = TRUE)
plant_diet_P <- plant_diet_P[!grepl("forage_fish", plant_diet_P)]
...
marine_diet_h2o <- marine_diet_h2o[!grepl("forage_fish", marine_diet_h2o)]

plant_diet_h2o <- list.files(here("data/spatial/plant_diet/int"), pattern = "_water_", full.names = TRUE)
plant_diet_h2o <- plant_diet_h2o[!grepl("forage_fish", plant_diet_h2o)]
