...
abline(v = quantile(all_disturbance_vals, 0.9999), lty=2)


disturbance_rescale_val <- quantile(all_disturbance_vals, 0.9999) |> as.numeric()
...
abline(v=quantile(all_ghg_vals, 0.9999), lty = 2)

#select the 99.9th percentile for rescaling
ghg_rescale_val <- quantile(all_ghg_vals, 0.9999) |> as.numeric()
...
abline(v=quantile(all_N_vals, 0.9999), lty = 2)


N_rescale_val <- quantile(all_N_vals, 0.9999)
...
abline(v=quantile(all_P_vals, 0.9999), lty = 2)

P_rescale_val <- quantile(all_P_vals, 0.9999) |> as.numeric()
...
abline(v=quantile(all_h2o_vals, 0.9999), lty = 2)


water_rescale_val <- quantile(all_h2o_vals, 0.9999) |> as.numeric()
