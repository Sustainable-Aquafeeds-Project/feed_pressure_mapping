...
AllocateSpatialCropDemand <- \(this_ingredient_source){
  ...
  if(!file.exists(this_demand_raster_filename)){
    ...
    this_updated_country_production_raster <-  this_country_production_raster* this_country_production/sum(terra::values(this_country_production_raster), na.rm=TRUE)
