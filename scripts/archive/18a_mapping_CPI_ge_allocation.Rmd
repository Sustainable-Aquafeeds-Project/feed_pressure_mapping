...
l_yellow <- "#F7F6C1"
light_gray <- "#F8F9FA"
discrete_pal <- c(l_yellow, yellow, green, l_brown, m_brown, d_brown, "red")
...
ggsave(plot = source_diet_map, filename = here("figures/source_vs_diet_visualisation_map_ge_allocation.jpg"), device = "jpg", dpi = 600, width = 18, height = 19, units = "cm")
```
