...
ggsave(plot = source_diet_map, filename = sprintf(here("figures/source_vs_diet_visualisation_map_%s.jpg"), this_allocation_method), device = "jpg", dpi = 600, width = 18, height = 19, units = "cm")
