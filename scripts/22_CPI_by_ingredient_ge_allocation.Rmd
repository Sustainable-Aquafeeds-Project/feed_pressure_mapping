...
for(source in sources){
    ...
    marine_diet_files <- 
      map(.x = marine_source_ingredient, .f = \(this_df){
        ...
        #nutrients
        this_nutrient_production_file <- these_ingredient_files[grepl("_nutrient_", these_ingredient_files) & !grepl("processing", these_ingredient_files)][[this_source_ingredient]]
