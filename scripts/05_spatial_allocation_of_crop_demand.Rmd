...
Get the mapspam codes of interest from the demand calculations, import the rasters into the project, and create new rasters reprojected with the gall-peters equal area projection. This takes a hot second (20+ mins). 
```{r}
