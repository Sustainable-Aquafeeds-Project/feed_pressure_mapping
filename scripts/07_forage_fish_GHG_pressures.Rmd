...
embodied_fish_new_gear <- 
  ...
  as_tibble() |> 
  mutate(fm_adj_embodied_fish_kg_ge = embodied_fish_adj_fm_ge *1000,
         fm_adj_embodied_fish_kg_mass = embodied_fish_adj_fm_mass *1000,
         fo_adj_embodied_fish_kg_ge = embodied_fish_adj_fo_ge *1000,
         fo_adj_embodied_fish_kg_mass = embodied_fish_adj_fo_mass *1000) |> 
  mutate(ei_kg_CO2_eq_fm_ge = fm_adj_embodied_fish_kg_ge*ei_kgco2_kgcatch,
         ei_kg_CO2_eq_fm_mass = fm_adj_embodied_fish_kg_mass*ei_kgco2_kgcatch,
         ei_kg_CO2_eq_fo_ge = fo_adj_embodied_fish_kg_ge*ei_kgco2_kgcatch,
         ei_kg_CO2_eq_fo_mass = fo_adj_embodied_fish_kg_mass*ei_kgco2_kgcatch)
...
embodied_fish_new_gear |> 
  select(diet, source_code, embodied_fish_adj_fo_ge, embodied_fish_adj_fm_ge, embodied_fish_adj_fo_mass, embodied_fish_adj_fm_mass) |> 
  group_by(diet, source_code) |> 
  summarise(fo_embedded_ge = sum(embodied_fish_adj_fo_ge, na.rm=TRUE),
            fm_embedded_ge = sum(embodied_fish_adj_fm_ge, na.rm = TRUE),
            fo_embedded_mass = sum(embodied_fish_adj_fo_mass, na.rm=TRUE),
            fm_embedded_mass = sum(embodied_fish_adj_fm_mass, na.rm = TRUE))
