...
Get species habitat data. This takes a couple of dats to run. Don't run if not needed. If needed, adjust the 'iucn_habitat_dir' to your storage.
...
Get species threats data. This takes a couple of dats to run. Don't run if not needed. If needed, adjust the 'iucn_threat_dir' to your storage.
