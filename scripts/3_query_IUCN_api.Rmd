...
tic()
habitat_list <- future_map(spp_list,  get_habitat_api)
toc()

habitat_list_df <- bind_cols(habitat_list)

saveRDS(object =  habitat_list_df, file = here("data/raw_data/iucn/habitats_by_spp.rds"))

```


Casey's method for IUCN
```{r}
