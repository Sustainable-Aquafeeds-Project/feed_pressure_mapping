...
To get the embodied_fish_by_cell.csv file imported below, you need to run the corresponding code in the fisheries section of 02_calculate_global_feed_demand.Rmd. Summarise the fisheries
