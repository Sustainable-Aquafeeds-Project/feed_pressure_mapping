...
| large_data | This folder is designed to hold data that is not able to be held in this github repository. It can be downloaded from <insertURL> and should be placed unmodified in the 'data' parent folder. i.e., the file path to the large data folder should be: "your_file_path_to_the_project_folder/feed_pressure_mapping/data/large_data", or, using the here library, here("data/large_data").
